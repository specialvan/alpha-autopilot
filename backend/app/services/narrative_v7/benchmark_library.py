...
class BenchmarkLibrary:
    ...
    def auto_prune_maintenance_alert_governance_escalation_remediations(
        ...
        *,
        ...
        return self._store.auto_prune_maintenance_alert_governance_escalation_remediations(dry_run=dry_run)
    ...
    def list_maintenance_alert_governance_escalation_remediation_auto_remediate_runs(
        ...
        *,
        ...
        return self._store.list_maintenance_alert_governance_escalation_remediation_auto_remediate_runs(
            limit=limit,
            cursor=cursor,
        )
    ...
    def summarize_maintenance_alert_governance_escalation_remediation_auto_remediate_runs(
        ...
        *,
        ...
        return self._store.summarize_maintenance_alert_governance_escalation_remediation_auto_remediate_runs(limit=limit)
    ...
    def export_maintenance_alert_governance_escalation_remediation_auto_remediate_runs(
        ...
        *,
        ...
        return self._store.export_maintenance_alert_governance_escalation_remediation_auto_remediate_runs(
            limit=limit,
            cursor=cursor,
        )
    ...
    def prune_maintenance_alert_governance_escalation_remediation_auto_remediate_runs(
        ...
        *,
        ...
        return self._store.prune_maintenance_alert_governance_escalation_remediation_auto_remediate_runs(
            keep_last=keep_last,
            dry_run=dry_run,
        )
    ...
    def auto_prune_maintenance_alert_governance_escalation_remediation_auto_remediate_runs(
        ...
        *,
        ...
        return self._store.auto_prune_maintenance_alert_governance_escalation_remediation_auto_remediate_runs(
            dry_run=dry_run,
        )
    ...
    def build_maintenance_alert_governance_escalation_remediation_auto_remediate_runs_digest(
        ...
        *,
        ...
        return self._store.build_maintenance_alert_governance_escalation_remediation_auto_remediate_runs_digest(limit=limit)
    ...
    def auto_remediate_maintenance_alert_governance_escalation_remediation_auto_remediate_runs(
        ...
        *,
        ...
        return self._store.auto_remediate_maintenance_alert_governance_escalation_remediation_auto_remediate_runs(
            dry_run=dry_run,
            limit=limit,
        )
    ...
    def prune_maintenance_alert_governance_escalation_remediation_auto_remediate_run_auto_remediate_runs(
        ...
        *,
        ...
        return self._store.prune_maintenance_alert_governance_escalation_remediation_auto_remediate_run_auto_remediate_runs(
            keep_last=keep_last,
            dry_run=dry_run,
        )
    ...
    def auto_prune_maintenance_alert_governance_escalation_remediation_auto_remediate_run_auto_remediate_runs(
        ...
        *,
        ...
        return self._store.auto_prune_maintenance_alert_governance_escalation_remediation_auto_remediate_run_auto_remediate_runs(
            dry_run=dry_run,
        )
    ...
    def build_maintenance_alert_governance_escalation_remediation_auto_remediate_run_auto_remediate_runs_digest(
        ...
        *,
        ...
        return self._store.build_maintenance_alert_governance_escalation_remediation_auto_remediate_run_auto_remediate_runs_digest(
            limit=limit
        )
    ...
    def auto_remediate_maintenance_alert_governance_escalation_remediation_auto_remediate_run_auto_remediate_runs(
        ...
        *,
        ...
        return self._store.auto_remediate_maintenance_alert_governance_escalation_remediation_auto_remediate_run_auto_remediate_runs(
            dry_run=dry_run,
            limit=limit,
        )
    ...
    def list_maintenance_alert_governance_escalation_remediation_auto_remediate_run_auto_remediate_runs_auto_remediate_runs(
        ...
        *,
        ...
        return self._store.list_maintenance_alert_governance_escalation_remediation_auto_remediate_run_auto_remediate_runs_auto_remediate_runs(
            limit=limit,
            cursor=cursor,
        )
    ...
    def summarize_maintenance_alert_governance_escalation_remediation_auto_remediate_run_auto_remediate_runs_auto_remediate_runs(
        ...
        *,
        ...
        return self._store.summarize_maintenance_alert_governance_escalation_remediation_auto_remediate_run_auto_remediate_runs_auto_remediate_runs(
            limit=limit
        )
    ...
    def export_maintenance_alert_governance_escalation_remediation_auto_remediate_run_auto_remediate_runs_auto_remediate_runs(
        ...
        *,
        ...
        return self._store.export_maintenance_alert_governance_escalation_remediation_auto_remediate_run_auto_remediate_runs_auto_remediate_runs(
            limit=limit,
            cursor=cursor,
        )
    ...
    def prune_maintenance_alert_governance_escalation_remediation_auto_remediate_run_auto_remediate_runs_auto_remediate_runs(
        ...
        *,
        ...
        return self._store.prune_maintenance_alert_governance_escalation_remediation_auto_remediate_run_auto_remediate_runs_auto_remediate_runs(
            keep_last=keep_last,
            dry_run=dry_run,
        )
    ...
    def auto_prune_maintenance_alert_governance_escalation_remediation_auto_remediate_run_auto_remediate_runs_auto_remediate_runs(
        ...
        *,
        ...
        return self._store.auto_prune_maintenance_alert_governance_escalation_remediation_auto_remediate_run_auto_remediate_runs_auto_remediate_runs(
            dry_run=dry_run,
        )
    ...
    def build_maintenance_alert_governance_escalation_remediation_auto_remediate_run_auto_remediate_runs_auto_remediate_runs_digest(
        ...
        *,
        ...
        return self._store.build_maintenance_alert_governance_escalation_remediation_auto_remediate_run_auto_remediate_runs_auto_remediate_runs_digest(
            limit=limit
        )
    ...
    def auto_remediate_maintenance_alert_governance_escalation_remediation_auto_remediate_run_auto_remediate_runs_auto_remediate_runs(
        ...
        *,
        ...
        return self._store.auto_remediate_maintenance_alert_governance_escalation_remediation_auto_remediate_run_auto_remediate_runs_auto_remediate_runs(
            dry_run=dry_run,
            limit=limit,
        )
    ...
    def list_maintenance_alert_governance_escalation_remediation_auto_remediate_run_auto_remediate_runs_auto_remediate_runs_auto_remediate_runs(
        ...
        *,
        ...
        return self._store.list_maintenance_alert_governance_escalation_remediation_auto_remediate_run_auto_remediate_runs_auto_remediate_runs_auto_remediate_runs(
            limit=limit,
            cursor=cursor,
        )
