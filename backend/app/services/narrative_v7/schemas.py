...
class BenchmarkMaintenanceAlertGovernancePolicy(BaseModel):
    ...
    governance_escalation_remediation_auto_remediate_run_auto_remediate_runs_prune_trigger_count: int = Field(
        default=0,
        ge=0,
    )
    governance_escalation_remediation_auto_remediate_run_auto_remediate_runs_prune_keep_last: int = Field(
        default=0,
        ge=0,
    )
    ...
    governance_escalation_remediation_auto_remediate_run_auto_remediate_runs_auto_remediate_runs_stale_seconds: int = (
        Field(
            default=0,
            ge=0,
        )
    ...
    governance_escalation_remediation_auto_remediate_runs_stale_seconds: int = Field(default=0, ge=0)
...
class BenchmarkMaintenanceAlertGovernanceEscalationRemediationAutoRemediateRunDigestResponse(BaseModel):
    model_config = ConfigDict(extra="forbid")
...
class BenchmarkMaintenanceAlertGovernanceEscalationRemediationAutoRemediateRunAutoRemediateRunRecord(BaseModel):
    model_config = ConfigDict(extra="forbid")
...
class BenchmarkMaintenanceAlertGovernanceEscalationRemediationAutoRemediateRunAutoRemediateRunListResponse(BaseModel):
    model_config = ConfigDict(extra="forbid")
...
class BenchmarkMaintenanceAlertGovernanceEscalationRemediationAutoRemediateRunAutoRemediateRunPruneResponse(BaseModel):
    model_config = ConfigDict(extra="forbid")
...
class BenchmarkMaintenanceAlertGovernanceEscalationRemediationAutoRemediateRunAutoRemediateRunAutoPruneResponse(BaseModel):
    model_config = ConfigDict(extra="forbid")
    ...
    malformed_line_count: int = Field(default=0, ge=0)
    should_prune: bool = False
    prune: BenchmarkMaintenanceAlertGovernanceEscalationRemediationAutoRemediateRunAutoRemediateRunPruneResponse | None = None
    message: str = ""


class BenchmarkMaintenanceAlertGovernanceEscalationRemediationAutoRemediateRunAutoRemediateRunDigestResponse(BaseModel):
    model_config = ConfigDict(extra="forbid")
...
class BenchmarkMaintenanceAlertGovernanceEscalationRemediationAutoRemediateRunAutoRemediateRunAutoRemediateResponse(
    BaseModel
):
    model_config = ConfigDict(extra="forbid")
    ...
    action: str = "observe"
    executed: bool = False
    remediated_orchestrator_runs: bool = False
    pruned_run_history: bool = False
    orchestrator_runs_auto_remediate: BenchmarkMaintenanceAlertGovernanceEscalationRemediationAutoRemediateRunAutoRemediateResponse | None = (
        None
    )
    run_history_auto_prune: BenchmarkMaintenanceAlertGovernanceEscalationRemediationAutoRemediateRunAutoRemediateRunAutoPruneResponse | None = (
        None
    )
    digest_before: BenchmarkMaintenanceAlertGovernanceEscalationRemediationAutoRemediateRunAutoRemediateRunDigestResponse
    digest_after: BenchmarkMaintenanceAlertGovernanceEscalationRemediationAutoRemediateRunAutoRemediateRunDigestResponse
    message: str = ""


class BenchmarkMaintenanceAlertGovernanceEscalationRemediationAutoRemediateRunAutoRemediateRunAutoRemediateRunRecord(
    BaseModel
):
    model_config = ConfigDict(extra="forbid")
...
class BenchmarkMaintenanceAlertGovernanceEscalationRemediationAutoRemediateRunAutoRemediateRunAutoRemediateRunListResponse(
    BaseModel
):
    model_config = ConfigDict(extra="forbid")
    ...
    total_records: int = Field(default=0, ge=0)
    malformed_line_count: int = Field(default=0, ge=0)
    records: list[BenchmarkMaintenanceAlertGovernanceEscalationRemediationAutoRemediateRunAutoRemediateRunAutoRemediateRunRecord] = (
        Field(default_factory=list)
    )
    message: str = ""


class BenchmarkMaintenanceAlertGovernanceEscalationRemediationAutoRemediateRunAutoRemediateRunAutoRemediateRunSummaryResponse(
    BaseModel
):
    model_config = ConfigDict(extra="forbid")
    ...
    apply_count: int = Field(default=0, ge=0)
    executed_count: int = Field(default=0, ge=0)
    remediated_orchestrator_runs_count: int = Field(default=0, ge=0)
    pruned_run_history_count: int = Field(default=0, ge=0)
    latest_record: BenchmarkMaintenanceAlertGovernanceEscalationRemediationAutoRemediateRunAutoRemediateRunAutoRemediateRunRecord | None = (
        None
    )
    message: str = ""


class BenchmarkMaintenanceAlertGovernanceEscalationRemediationAutoRemediateRunAutoRemediateRunAutoRemediateRunExportResponse(
    BaseModel
):
    model_config = ConfigDict(extra="forbid")
    ...
    total_records: int = Field(default=0, ge=0)
    malformed_line_count: int = Field(default=0, ge=0)
    summary: BenchmarkMaintenanceAlertGovernanceEscalationRemediationAutoRemediateRunAutoRemediateRunAutoRemediateRunSummaryResponse
    records: list[BenchmarkMaintenanceAlertGovernanceEscalationRemediationAutoRemediateRunAutoRemediateRunAutoRemediateRunRecord] = (
        Field(default_factory=list)
    )
    message: str = ""
...
class BenchmarkMaintenanceAlertGovernanceEscalationRemediationAutoRemediateRunAutoRemediateRunAutoRemediateRunPruneResponse(
    BaseModel
):
    model_config = ConfigDict(extra="forbid")
...
class BenchmarkMaintenanceAlertGovernanceEscalationRemediationAutoRemediateRunAutoRemediateRunAutoRemediateRunDigestResponse(
    BaseModel
):
    model_config = ConfigDict(extra="forbid")
...
class BenchmarkMaintenanceAlertGovernanceEscalationRemediationAutoRemediateRunAutoRemediateRunAutoRemediateRunAutoRemediateResponse(
    BaseModel
):
    model_config = ConfigDict(extra="forbid")
    ...
    action: str = "observe"
    executed: bool = False
    remediated_orchestrator_runs_auto_remediate_runs: bool = False
    pruned_run_history: bool = False
    orchestrator_runs_auto_remediate_runs_auto_remediate: BenchmarkMaintenanceAlertGovernanceEscalationRemediationAutoRemediateRunAutoRemediateRunAutoRemediateResponse | None = (
        None
    )
    run_history_auto_prune: BenchmarkMaintenanceAlertGovernanceEscalationRemediationAutoRemediateRunAutoRemediateRunAutoRemediateRunAutoPruneResponse | None = (
        None
    )
    digest_before: BenchmarkMaintenanceAlertGovernanceEscalationRemediationAutoRemediateRunAutoRemediateRunAutoRemediateRunDigestResponse
    digest_after: BenchmarkMaintenanceAlertGovernanceEscalationRemediationAutoRemediateRunAutoRemediateRunAutoRemediateRunDigestResponse
    message: str = ""


class BenchmarkMaintenanceAlertGovernanceEscalationRemediationAutoRemediateRunAutoRemediateRunAutoRemediateRunAutoRemediateRunRecord(
    BaseModel
):
    model_config = ConfigDict(extra="forbid")
...
class BenchmarkMaintenanceAlertGovernanceEscalationRemediationAutoRemediateRunAutoRemediateRunAutoRemediateRunAutoRemediateRunListResponse(
    BaseModel
):
    model_config = ConfigDict(extra="forbid")
